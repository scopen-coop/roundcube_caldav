class Display {
    ...
    display_message_if_event_is_already_on_server() {
        ...
        if (
            this.array_response.identity !== undefined
            &&  this.array_response['attendees'] !== undefined 
        ) {
    ...
    display_date() {
        if (this.array_response['same_date']) {
            ...
            if (
                this.array_response['date_hours_start'] !== '0:00' 
                || this.array_response['date_hours_end'] !== '0:00'
            ) {
    ...
    display_modified_date() {
        if (this.array_response['new_date']) {
            ...
            if (this.array_response['new_date']['same_date']) {
                ...
                if (
                    this.array_response['new_date']['date_hours_start'] !== '0:00' 
                    || this.array_response['new_date']['date_hours_end'] !== '0:00'
                ) {
    ...
    display_location_and_description() {
        let display_location = true, display_description = true;
    ...
    display_title() {
        ...
        let modif = 
            this.array_response['new_description'] 
            || this.array_response['new_location']
            || this.array_response['new_date'] 
            || this.array_response['new_attendees'];
