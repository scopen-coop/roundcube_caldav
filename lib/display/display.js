class Display {
    ...
    display_modification_message() {
        ...
        if (isACounter && this.array_response['found_on_calendar'] && (this.array_response['new_description'] || this.array_response['new_location'] || this.array_response['new_date'])) {
    ...
    display_select_calendars() {
        ...
        let display_calendar = (isACounter || isAReply || isARequest || isADeclineCounter) && !this.array_response['found_older_event_on_calendar'];
